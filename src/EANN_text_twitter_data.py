...
import time, os
# import random
import process_data_data as process_data
import copy
import pickle
...
class CNN_Fusion(nn.Module):
    def __init__(self, args, W):
        ...
        self.class_classifier.add_module('c_fc1',  nn.Linear(self.hidden_size, C))
        ...
        self.modal_classifier.add_module('m_fc2', nn.Linear(self.hidden_size, C))
...
def main(args,seed):
    ...
    for epoch in range(args.num_epochs):
        ...
        for i, (train_data, train_labels, event_labels) in enumerate(train_loader):
            ...
            event_labels = torch.Tensor(event_labels).long()
        ...
        for i, (validate_data, validate_labels, event_labels) in enumerate(validate_loader):
            ...
            validate_labels = torch.Tensor(validate_labels).long()
        ...
        if validate_acc > best_validate_acc and args.data_division=='random':
...
#best_validate_dir = args.output_file + 'baseline_text_weibo_GPU2_out.' + str(20) + '.pkl'
    ...
    for i, (test_data, test_labels, event_labels) in enumerate(test_loader):
        ...
        if i == 0:
            ...
            print(test_score.shape,to_np(test_outputs).shape,to_np(test_outputs.squeeze()).shape)
...
def concat_data(dict1,dict2):
    ...
    return result
def load_data(args):
    train, validate, test = process_data.get_data(args.text_only,args)
    #print(train[4][0])
    
    if args.data_division=='event':
        test=concat_data(test,validate)
    
        # test.extend(validate)
...
if __name__ == '__main__':
    ...
    train = ''
    test = ''
    output ='../data/output/'+datasetname+'/'
    args = parser.parse_args([train, test, output])
    args.datasetname = datasetname
    func = lambda z: dict([(x, y) for y, x in z.items()])
    eventid = pickle.load(open("../data/" + args.datasetname + "_id_event_data.pickle", 'rb'))
    eventid1 = func(func(eventid))
    args.event_num = len(eventid1.values())
    print(args.event_num)
    ...
    if type == 'train' and args.data_division=='event':
        ...
        for iter in range(iterations):
            setup_seed(20)
            print('seed=20, t=0.8')
            fold0_x_test, fold0_x_train_8, fold0_x_train_2, fold0_x_100_train = load5foldDataT(args.datasetname, data_path,
                                                                                           label_path, 3)
            ...
            accs_0, acc1_0, pre1_0, rec1_0, F1_0, acc2_0, pre2_0, rec2_0, F2_0, acc3_0, pre3_0, rec3_0, F3_0, acc4_0, pre4_0, rec4_0, F4_0 = main(args,'20')
            ...
            fold0_x_train_8.extend(fold0_x_train_2)
            args.datalist = [args.datasetname, fold0_x_test, fold0_x_train_8, fold0_x_train_2, fold0_x_100_train]
            accs_1, acc1_1, pre1_1, rec1_1, F1_1, acc2_1, pre2_1, rec2_1, F2_1, acc3_1, pre3_1, rec3_1, F3_1, acc4_1, pre4_1, rec4_1, F4_1 = main(args,'30')
            ...
            fold0_x_train_8.extend(fold0_x_train_2)
            args.datalist = [args.datasetname, fold0_x_test, fold0_x_train_8, fold0_x_train_2, fold0_x_100_train]
            accs_2, acc1_2, pre1_2, rec1_2, F1_2, acc2_2, pre2_2, rec2_2, F2_2, acc3_2, pre3_2, rec3_2, F3_2, acc4_2, pre4_2, rec4_2, F4_2 = main(args,'40')
            ...
            fold0_x_train_8.extend(fold0_x_train_2)
            args.datalist = [args.datasetname, fold0_x_test, fold0_x_train_8, fold0_x_train_2, fold0_x_100_train]
            accs_3, acc1_3, pre1_3, rec1_3, F1_3, acc2_3, pre2_3, rec2_3, F2_3, acc3_3, pre3_3, rec3_3, F3_3, acc4_3, pre4_3, rec4_3, F4_3 = main(args,'50')
            ...
            fold0_x_train_8.extend(fold0_x_train_2)
            args.datalist = [args.datasetname, fold0_x_test, fold0_x_train_8, fold0_x_train_2, fold0_x_100_train]
            accs_4, acc1_4, pre1_4, rec1_4, F1_4, acc2_4, pre2_4, rec2_4, F2_4, acc3_4, pre3_4, rec3_4, F3_4, acc4_4, pre4_4, rec4_4, F4_4 = main(args,'60')
        ...
        for iter in range(iterations):
            ...
            fold4_test, fold4_val,fold4_train= load5foldDataT(datasetname,data_path,label_path,4)
